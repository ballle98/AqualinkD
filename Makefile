...
SRCS = aqualinkd.c utils.c config.c aq_serial.c init_buttons.c aq_programmer.c net_services.c net_services_habridge.c json_messages.c pda_menu.c mongoose.c
